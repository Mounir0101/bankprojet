...
$pages = ['home', 'contact', 'signup', 'login', 'admin_contact', 'retrait_bdd, conversion_euro, conversion_dollars, conversion_bitcoin, conversion, operations, depot_bdd, transactions, logout, accountPage'];
